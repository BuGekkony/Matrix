...
public class NTSC_FPS_Resolution1080 extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public NTSC_FPS_Resolution1080() {
        videoFPS = new String[]{"24", "30", "48", "60", "90", "120"};
        TAG = NTSC_FPS_Resolution1080.class.getSimpleName();
    }

    public static NTSC_FPS_Resolution1080 newInstance() {
        return new NTSC_FPS_Resolution1080();
    }
