...
public class FOV_W_M_N extends DialogFragment {
    ...
    public FOV_W_M_N() {
        videoFOV = new String[]{"Amplo", "Médio", "Estreito"};
        TAG = FOV_W_M_N.class.getSimpleName();
    }

    public static FOV_W_M_N newInstance() {
        return new FOV_W_M_N();
    }
