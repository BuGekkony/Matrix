...
public class PAL_FPS_Resolution27K extends DialogFragment {

    private String TAG;
    private String[] videoFPS;


    public PAL_FPS_Resolution27K() {
        videoFPS = new String[]{"24", "25", "48", "50"};
        TAG = PAL_FPS_Resolution27K.class.getSimpleName();
    }

    public static PAL_FPS_Resolution27K newInstance() {
        return new PAL_FPS_Resolution27K();
    }
