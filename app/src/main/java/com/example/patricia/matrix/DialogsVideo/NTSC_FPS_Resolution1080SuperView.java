...
public class NTSC_FPS_Resolution1080SuperView extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public NTSC_FPS_Resolution1080SuperView() {
        videoFPS = new String[]{"24", "30", "48", "60", "80"};
        TAG = NTSC_FPS_Resolution1080SuperView.class.getSimpleName();
    }

    public static NTSC_FPS_Resolution1080SuperView newInstance() {
        return new NTSC_FPS_Resolution1080SuperView();
    }
