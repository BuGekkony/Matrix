...
public class NTSC_FPS_Resolution_27SuperView extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public NTSC_FPS_Resolution_27SuperView(){
        videoFPS = new String[]{"30"};
        TAG = NTSC_FPS_Resolution_27SuperView.class.getSimpleName();
    }

    public static NTSC_FPS_Resolution_27SuperView newInstance() {
        return new NTSC_FPS_Resolution_27SuperView();
    }
