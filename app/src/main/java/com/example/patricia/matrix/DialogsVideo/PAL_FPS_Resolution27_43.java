...
public class PAL_FPS_Resolution27_43 extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public PAL_FPS_Resolution27_43() {
        videoFPS = new String[]{"25"};
        TAG = PAL_FPS_Resolution27_43.class.getSimpleName();
    }

    public static PAL_FPS_Resolution27_43 newInstance() {
        return new PAL_FPS_Resolution27_43();
    }
