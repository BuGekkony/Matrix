...
public class PAL_FPS_Resolution720SuperView extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public PAL_FPS_Resolution720SuperView() {
        videoFPS = new String[]{"50", "120"};
        TAG = PAL_FPS_Resolution720SuperView.class.getSimpleName();
    }

    public static PAL_FPS_Resolution720SuperView newInstance() {
        return new PAL_FPS_Resolution720SuperView();
    }
