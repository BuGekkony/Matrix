...
public class PAL_FPS_Resolution1440 extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public PAL_FPS_Resolution1440() {
        videoFPS = new String[]{"24", "25", "48", "50", "80"};
        TAG = PAL_FPS_Resolution1440.class.getSimpleName();
    }

    public static PAL_FPS_Resolution1440 newInstance() {
        return new PAL_FPS_Resolution1440();
    }
