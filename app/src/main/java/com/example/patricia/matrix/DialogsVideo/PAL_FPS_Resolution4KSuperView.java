...
public class PAL_FPS_Resolution4KSuperView extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public PAL_FPS_Resolution4KSuperView() {
        videoFPS = new String[]{"24"};
        TAG = PAL_FPS_Resolution4KSuperView.class.getSimpleName();
    }

    public static PAL_FPS_Resolution4KSuperView newInstance() {
        return new PAL_FPS_Resolution4KSuperView();
    }
