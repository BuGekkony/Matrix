...
public class NTSC_FPS_Resolution27K extends DialogFragment {

    private String TAG;
    private String[] videoFPS;

    public NTSC_FPS_Resolution27K() {
        videoFPS = new String[]{"24", "30", "48", "60"};
        TAG = NTSC_FPS_Resolution27K.class.getSimpleName();
    }

    public static NTSC_FPS_Resolution27K newInstance() {
        return new NTSC_FPS_Resolution27K();
    }
